...
import founderImg2 from "../../assets/images/latest/img7.jpg";
const Founder = () => {
  return (
    <section>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 md:gap-16 z-10 relative">
            ...
            <div className="xl:col-span-2 mt-5">
              <div className="lg:text-white/90 mb-6 xl:mb-12">
                ...
                <h4 className="text-[22px] md:text-[28px] lg:text-[32px] leading-none">Co-Founder & CTO</h4>
              </div>
              <div>
                <div className="text-base sm:text-[18px] lg:text-[22px] text-zinc-400 font-tommy">
                  <p className="my-5 leading-tight md:text-justify font-tommy_light font-medium">
              ...
              <div className="  text-zinc-400 font-tommy mt-5">
                ...
                <div className="text-base sm:text-[18px] lg:text-[22px]">
                  <p className="leading-tight  md:text-justify font-tommy_light font-medium">
                    During his tenure as Vice President of Manage within the DocuSign Agreement Cloud, Damon Danieli played a pivotal role in
                    supporting the Machine Learning/Artificial Intelligence strategy. He took ownership of customer-facing features like In Product
                    Reporting and security reporting through DocuSign Monitor. Additionally, he laid the foundations of DocuSign&apos;s ML/AI
                    infrastructure.
                  </p>
                </div>
              </div>
            ...
            <div className="  text-zinc-400 font-tommy mt-7">
              ...
              <div className="text-base sm:text-[18px] lg:text-[22px]">
                <p className="leading-tight  md:text-justify font-tommy_light font-medium">
                  ...
                  contributions led to over 50 million downloads of titles such as Battle Nations, Trade Nations, and MetalStorm: Wingman.
                  Z2Live&apos;s acquisition by King in February 2015 marked a testament to Damon&apos;s impact on the gaming world.
                </p>
              </div>
            </div>
            {/* =========================================== */}
            ...
            <div className="  text-zinc-400 font-tommy mt-7">
              ...
              <div className="text-base sm:text-[18px] lg:text-[22px]">
                <p className="leading-tight  md:text-justify font-tommy_light font-medium">
                  ...
                  Live. He crafted functional specifications for marquee features like voice chat, voice commands, and friends. His leadership
                  extended to managing complex technical challenges and teams of project managers. Gamers may recognize him by his Xbox Live Gamertag.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ====================== */}
      <section id="founder" className="pb-24 md:pb-44 lg:pb-72 relative overflow-hidden">
        <div className="container_fluid">
          <div className="w-full h-32 bg-black absolute z-0 hidden lg:block xl:right-[30%] 2xl:right-[35%]"></div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 md:gap-16 z-10 relative">
            <div className="xl:col-span-2 mt-5 order-2 xl:order-1">
              <div className="lg:text-white/90 mb-6 xl:mb-12">
                ...
                <h4 className="text-[22px] md:text-[28px] lg:text-[32px] leading-none">Co-Founder & CEO</h4>
              </div>
              <div>
                <div className="text-base sm:text-[18px] lg:text-[22px] text-zinc-400 font-tommy">
                  <p className="my-5 leading-tight md:text-justify font-tommy_light font-medium">
                    Sisi Mak Danieli, is a South African beauty queen, and entrepreneur with a strong foothold in both the entertainment and business
                    realms. Her journey is a testament to her passion for both fields
                  </p>
                </div>
              </div>
              <div className="  text-zinc-400 font-tommy mt-5">
                ...
                <div className="text-base sm:text-[18px] lg:text-[22px]">
                  <p className="leading-tight  md:text-justify font-tommy_light font-medium">
                    Sisi held the position of CEO at MTProjects, a civil works construction company, for 12 years. Her responsibilities included
                    overseeing the operations of this multi-million Rand SMME business while actively marketing it.
                  </p>
                </div>
              </div>
